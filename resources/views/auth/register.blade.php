        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    border-red-500 @enderror" values="{{ old('name') }}"> 
                ...
                <div class="mb-4">
                    ...
                    border-red-500 @enderror" values="{{ old('username') }}"> 
                ...
                <div class="mb-4">
                    ...
                    border-red-500 @enderror" values="{{ old('email') }}"> 
                ...
                <div class="mb-4">
                    ...
                    border-red-500 @enderror" values=""> 
